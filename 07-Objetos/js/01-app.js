...
// La sintaxis del objeto es con llaves ={}, y las llaves del objeto se les asigna el valor con :
// Object literal
const producto = {
    nombre: 'Monitor de 20 Pulgadas',        // Propiedad / Llave del objeto
    precio: 300,           // Para agregar mas llaves es obligatorio usar , al final
    disponible: true
}
